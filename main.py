...
PERSONALITY_SET_TALK = {
    "Assistant"    : "I will like to call you HAM-R and please act as an assistant",
    "Doctor"       : "I will like to call you dr HAM-R and please act as an Doctor",
    "Astrophysicst": "I will like to call you HAM-R and please act as an Astrophysicst",
    "Teacher"      : "I will like to call you HAM-R and please act as an Teacher"
}
...
def web_main():
    ...
    def receive_settings_from_frontend():
        ...
        if (Personality != data.get("personality")):
            ...
            blackboxai.talk(PERSONALITY_SET_TALK[Personality])
